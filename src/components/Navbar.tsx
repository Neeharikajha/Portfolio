export default function Navbar({
  ...
  // center name should be hidden only when on the hero section
  const centerVisible = !(page === "home" && scrollY <= heroHeight - 20);
  ...
  return (
    <>
      {/* overlay below navbar to mask overlapping content with matching dotted style */}
      <div
        style={{
          position: "fixed",
          top: 0,
          ...
          zIndex: 50,
          pointerEvents: "none",
          backgroundColor: "rgba(235,227,209,0.95)",
